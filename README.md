...
This SDK facilitates interactions with the contracts in [Universal Router](https://github.com/YumYumToken/universal-router)
...
import { Trade as V2TradeSDK } from '@yumyumswap/v2-sdk'
import { Trade as V3TradeSDK } from '@yumyumswap/swap-sdk'
